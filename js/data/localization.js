export const translations = {
  en: {
    ...
    equipmentTarget: 'Equipment — {member}',
    manageGear: 'Manage Gear',
    equip: 'Equip',
    unequip: 'Unequip',
    empty: 'Empty',
    gearArmour: 'Armour',
    ...
    levelLabel: 'Level',
    expLabel: 'EXP',
    companionRoleVanguard: 'Vanguard',
    partyMemberSummary: 'Lv {level} • {role} • {element}',
    battleCompanionReady: '{count} companion(s) battle-ready in party',
    noActiveCompanion: 'No active companion',
    battleActionLine: '{actor} used {skill} on {target} for {damage} damage.',
    battleCompanionUnableToAct: '{companion} is unable to act.',
    ...
    levelUp: 'Level Up!',
    companionGainedExp: '{companion} gained {amount} EXP',
    companionLevelUp: '{companion} leveled up! Lv {level}',
    ...
    npcSafeHealerPrompt: 'Would you like me to heal you and your active party members?',
    npcSafeHealerConfirmed: 'All set. Your party is fully healed.',
    npcSafeHealerDeclined: 'All right. Come back whenever you need healing.',
    npcSafeGearIntro: 'Roads outside the village can be rough. Take these Traveler\'s Boots and cross marsh tiles safely.',
    npcSafeGearRewardGiven: 'You received Traveler\'s Boots.',
    npcSafeGearFollowup: 'Keep those boots equipped when crossing swamps. They make tricky ground passable.',
    narrator: 'Narrator',
  ...
  ja: {
    ...
    levelLabel: 'レベル',
    expLabel: '経験値',
    companionRoleVanguard: '前衛',
    partyMemberSummary: 'Lv {level} • {role} • {element}',
    battleCompanionReady: '戦闘準備中の仲間: {count}人',
    noActiveCompanion: 'アクティブな仲間はいません',
    battleActionLine: '{actor}の{skill}！ {target}に{damage}ダメージ。',
    battleCompanionUnableToAct: '{companion}は行動不能です。',
    fireSlime: 'ファイアスライム',
    earthSlime: 'アーススライム',
    ...
    levelUp: 'レベルアップ！',
    companionGainedExp: '{companion}は{amount} EXPを獲得',
    companionLevelUp: '{companion}はレベルアップ！ Lv {level}',
    continueToGrid: '続ける',
    ...
    npcSafeHealerPrompt: 'あなたとアクティブパーティを回復しますか？',
    npcSafeHealerConfirmed: '回復しました。パーティは全快です。',
    npcSafeHealerDeclined: 'わかりました。必要になったらいつでも来てください。',
    npcSafeGearIntro: '村の外の道は荒れています。旅人のブーツを受け取って、湿地タイルを安全に渡ってください。',
    npcSafeGearRewardGiven: '旅人のブーツを受け取りました。',
    npcSafeGearFollowup: '沼地を渡るときは、そのブーツを装備してください。進みにくい地形を通れるようになります。',
    narrator: '語り手',
  ...
  ru: {
    ...
    equipmentTarget: 'Снаряжение — {member}',
    manageGear: 'Управление снаряжением',
    equip: 'Экипировать',
    unequip: 'Снять',
    empty: 'Пусто',
    gearArmour: 'Броня',
    ...
    levelLabel: 'Уровень',
    expLabel: 'Опыт',
    companionRoleVanguard: 'Авангард',
    partyMemberSummary: 'Ур. {level} • {role} • {element}',
    battleCompanionReady: 'В отряде готовых спутников: {count}',
    noActiveCompanion: 'Нет активного спутника',
    battleActionLine: '{actor} использует {skill} по цели {target} и наносит {damage} урона.',
    battleCompanionUnableToAct: '{companion} не может действовать.',
    ...
    companionGainedExp: '{companion} получает {amount} опыта',
    companionLevelUp: '{companion} повышает уровень! Ур. {level}',
    ...
    npcSafeHealerPrompt: 'Хотите, чтобы я исцелила вас и активных спутников?',
    npcSafeHealerConfirmed: 'Готово. Ваша группа полностью восстановлена.',
    npcSafeHealerDeclined: 'Хорошо. Возвращайтесь, когда понадобится лечение.',
    npcSafeGearIntro: 'За пределами деревни дорога тяжёлая. Возьмите Сапоги путешественника — в них безопасно проходить болотные клетки.',
    npcSafeGearRewardGiven: 'Вы получили Сапоги путешественника.',
    npcSafeGearFollowup: 'Не забывайте экипировать эти сапоги перед болотами. Они помогут пройти трудную местность.',
    narrator: 'Рассказчик',
  ...
  ar: {
    ...
    equipmentTarget: 'المعدات — {member}',
    manageGear: 'إدارة المعدات',
    equip: 'تجهيز',
    unequip: 'إزالة',
    empty: 'فارغ',
    gearArmour: 'درع',
    ...
    levelLabel: 'المستوى',
    expLabel: 'الخبرة',
    companionRoleVanguard: 'مقدمة القتال',
    partyMemberSummary: 'المستوى {level} • {role} • {element}',
    battleCompanionReady: 'رفاق جاهزون للمعركة في الفريق: {count}',
    noActiveCompanion: 'لا يوجد رفيق نشط',
    battleActionLine: '{actor} استخدم {skill} على {target} وألحق {damage} ضررًا.',
    battleCompanionUnableToAct: '{companion} غير قادر على القتال.',
    ...
    companionGainedExp: '{companion} حصل على {amount} خبرة',
    companionLevelUp: '{companion} ارتفع مستواه! المستوى {level}',
    ...
    npcSafeHealerPrompt: 'هل تريد أن أعالجك أنت ورفاقك النشطين؟',
    npcSafeHealerConfirmed: 'تم الأمر. تم شفاء مجموعتك بالكامل.',
    npcSafeHealerDeclined: 'حسنًا. عد إليّ متى احتجت إلى العلاج.',
    npcSafeGearIntro: 'الطرق خارج القرية قاسية. خذ أحذية الرحّالة لتتمكن من عبور بلاطات المستنقع بأمان.',
    npcSafeGearRewardGiven: 'لقد حصلت على أحذية الرحّالة.',
    npcSafeGearFollowup: 'أبقِ هذه الأحذية مجهّزة عند عبور المستنقعات، فهي تجعل الأرض الصعبة قابلة للمرور.',
    narrator: 'الراوي',
