...
export const FIRE_BIOME_MAP_ID = 'map_fire_biome_01';
export const FIRE_BIOME_MAP_ENTRY = { x: 1, y: 10 };
export const SAFE_VILLAGE_MAP_ID = 'map_safe_village_01';
export const SAFE_VILLAGE_MAP_ENTRY = { x: 1, y: 10 };
